# >> CREDITS << 
# Vector2d.py written by PyGame and forked by Haashim Hussain
# Original file: http://www.pygame.org/wiki/2DVectorClass 

# >> DESCRIPTION <<
# This is a module that contains a Vector2 Class
# It is a 2D Vector useful for all positioning
# It has been forked to allow me to edit specifc values.
